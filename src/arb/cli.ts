 ...
 *
 * This reports; it does not trade. DRY_RUN is not consulted here because no
 * transaction is ever built in this module.
 */
...
function parseArgs(argv: string[]): {
  ...
  return { json, watch, dislocationsOnly, minSpreadBps };
}
